...
<div align="center">
  <img src="https://media.giphy.com/media/pVGsAWjzvXcZW4ZBTE/giphy.gif" width="100%" height="auto" />
</div>
...
- 💻 **Web Developer** with solid experience in both front-end and back-end stacks.
...
### 🎓 Certifications
![eJPT](https://img.shields.io/badge/eJPT-CERTIFIED-blue)  
Certified in foundational penetration testing methodologies and tools.

![OSCP](https://img.shields.io/badge/OSCP-in--progress-orange)  
Currently pursuing the **Offensive Security Certified Professional**, focused on real-world exploit development and red teaming.

### 🔧 Technical Focus
- Windows privilege escalation (DLL Hijacking, UAC Bypass, Token Impersonation, etc.)
- Post-exploitation techniques and credential dumping
- Red teaming and adversary simulation
- Active Directory enumeration and attacks

### 🕹️ CTF & Lab Engagement
...
A PHP-based project for helping people with ADHD.  
**Technologies**: HTML, CSS, PHP, JavaScript

### [📋 MyProTask Front](https://github.com/Aristex12/MyProTask_front)
A front-end application for managing employees and projects.  
**Technologies**: Angular, TypeScript, CSS

### [🧩 MyProTask Back](https://github.com/Aristex12/MyProTask_back)
A complete backend system for employee/project management.  
...
- 💼 **LinkedIn**: [linkedin.com/in/arismaximiliankuhs](https://www.linkedin.com/in/arismaximiliankuhs)
...
> *"I seek out challenges that test my limits. Whether in coding or competition, I thrive on growth, learning, and delivering impactful results."*
